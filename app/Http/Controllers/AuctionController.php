...
public function show($id)
{
    ...
    $startDate = $auctionListing->auction_start ?? $auctionListing->created_at; // adjust if you have a dedicated start column
    ...
    return view('showAuctionDetail', compact('auctionListing', 'currentBid', 'images', 'mainImage', 'endDate'));
}
