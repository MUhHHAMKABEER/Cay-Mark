...
return [
    ...
    */
    ...
    | will be used by the PHP date and date-time functions. Set this in
    | .env as APP_TIMEZONE (e.g. Asia/Karachi for Pakistan) so approval
    | and auction times use your local business hours (8 AM–8 PM).
    |
    */
