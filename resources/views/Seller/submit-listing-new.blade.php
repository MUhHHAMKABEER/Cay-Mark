...
<div class="flex-1 min-h-0 w-full overflow-y-auto overflow-x-hidden bg-[#FDFBF8] p-4 sm:p-6 lg:p-8">
    <div class="w-full max-w-7xl mx-auto">
        ...
        <form id="listingForm" data-cm-validate="off" action="{{ $isEdit ? route('seller.listings.update.post', $listing->id) : route('seller.listings.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
