    ...
    <div class="container mx-auto px-4 py-6">
        <nav class="text-sm mb-6 text-gray-600">
            <ol class="list-reset flex flex-wrap items-center gap-x-2">
                ...
                <li><span class="text-gray-400">/</span></li>
                <li><a href="{{ route('seller.listings.show', $listing->id) }}" class="text-blue-600 hover:underline">Preview</a></li>
                <li><span class="text-gray-400">/</span></li>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 max-w-2xl mx-auto text-center">
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-4">
                <a href="{{ route('seller.listings.show', $listing->id) }}" class="px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700">
                    Back to Preview
                </a>
