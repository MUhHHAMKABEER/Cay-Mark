    ...
    <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div class="footer-column">
                <h3 class="footer-heading text-xl font-bold font-heading" style="color: #ffffff;">About CayMark</h3>
                <p class="mb-6 leading-relaxed" style="color: #ffffff;">
                    CayMark is a premier online vehicle auction platform connecting buyers
                    and sellers worldwide with transparent, efficient, and secure marketplace solutions.
                </p>
            ...
            <div class="footer-column">
                ...
                <ul class="space-y-3">
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">chevron_right</span> How to Buy</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">chevron_right</span> Sell My Car</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">chevron_right</span> Live Auctions</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">chevron_right</span> Financing Options</a></li>
                </ul>
            </div>

            <div class="footer-column">
                <h3 class="footer-heading text-xl font-bold font-heading" style="color: #ffffff;">Vehicle Categories</h3>
                <ul class="space-y-3">
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">directions_car</span> Cars & Sedans</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">local_shipping</span> Trucks & Vans</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">agriculture</span> SUVs & Crossovers</a></li>
                    <li><a href="#" style="color: #ffffff; text-decoration: none;" class="footer-link flex items-center py-1"><span class="material-icons mr-2 text-sm">two_wheeler</span> Motorcycles</a></li>
                </ul>
            </div>
            ...
            <div class="footer-column">
                ...
                <ul class="space-y-4" style="color: #ffffff;">
                    ...
                    <li class="flex items-center py-1"><span class="material-icons mr-3" style="color: #ffffff;">call</span>+1 (800) 555-CARS</li>
        ...
        <div class="newsletter-box p-8 mb-12" style="color: #ffffff;">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-6 md:mb-0 md:mr-8 text-center md:text-left">
                    <h3 class="text-2xl font-bold mb-2 font-heading" style="color: #ffffff;">Stay Updated</h3>
                    <p style="color: #ffffff;">Subscribe to our newsletter for auction updates and exclusive vehicle deals</p>
                </div>
                <form class="flex flex-col sm:flex-row w-full md:w-auto">
                    <input type="email" placeholder="Your email address"
                        class="px-4 py-3 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-80 transition-all duration-300"
        ...
        <div class="footer-bottom flex flex-col md:flex-row justify-between items-center">
            <p style="color: #ffffff;" class="text-sm mb-4 md:mb-0">&copy; {{ date('Y') }} CayMark Auctions. All rights reserved.</p>
