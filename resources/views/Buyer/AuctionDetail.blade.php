...
<div class="ad-grid">
    ...
    <div id="ad-bid">
        ...
        {{-- Bidding widget --}}
        <div class="ad-card bid-widget" style="position:sticky;top:5.5rem;">
            ...
            @else
            {{-- Logged in but registration is incomplete (no buyer role yet) --}}
            <div style="background:#fff7ed;border:1.5px solid #fb923c;border-radius:10px;padding:16px;margin-bottom:4px">
                <div style="display:flex;align-items:center;gap:7px;margin-bottom:8px">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#ea580c" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                    <span style="font-size:13px;font-weight:700;color:#ea580c">Registration Required to Bid</span>
                </div>
                <p style="font-size:12.5px;color:#7c2d12;margin:0 0 8px;line-height:1.5">
                    Please complete the following in your User tab before placing a bid:
                </p>
                <ul style="margin:0 0 12px;padding:0;list-style:none">
                    <li style="font-size:12px;color:#78350f;display:flex;align-items:center;gap:5px;margin-bottom:4px">
                    ...
                    <li style="font-size:12px;color:#78350f;display:flex;align-items:center;gap:5px">
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
                        Add your phone number
                    </li>
                </ul>
                <a href="{{ route('finish.registration') }}"
                   style="display:flex;align-items:center;justify-content:center;gap:7px;width:100%;padding:11px;background:#ea580c;color:#fff;border-radius:8px;font-size:13.5px;font-weight:700;text-decoration:none;transition:background .15s"
